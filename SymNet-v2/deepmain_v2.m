function [cov_all, Sum_CovMaps] = deepmain_v2()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This method deepmain_v2 only returns the SPD matrices
% 1. Covariance matrix
...
fprintf("\ncov_all for DeepMain V2");
chol(cov_all)
save("cov_all_deepmain_v2_SymNet.mat", "cov_all")
...
fprintf("\nSum_CovMaps for DeepMain V2");
chol(Sum_CovMaps)
save("Sum_CovMaps_deepmain_v2_SymNet.mat", "Sum_CovMaps")
